...
cmd({
  ...
  try {
    ...
    if (!args.length) {
      return reply(
`✨ *Example Usage:*
.profilecard name=TESLA-XPACE rankName=Pro rankId=2 level=15 exp=500 requireExp=900 avatarURL=https://files.catbox.moe/xksplb.jpg.jpg backgroundURL=https://files.catbox.moe/xksplb.jpg
