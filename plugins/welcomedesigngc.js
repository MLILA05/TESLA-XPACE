...
cmd({
    ...
    try {
        ...
        const defaultAvatar = 'https://files.catbox.moe/xksplb.jpgg';
        const defaultBg = 'https://files.catbox.moe/xksplb.jpg';
        ...
        if (m.quoted && (m.quoted.type === 'imageMessage' || m.quoted.message?.imageMessage)) {
            try {
                ...
                // Ignore upload failures and fall back to profile/default images.
            }
        }
        ...
        if (!backgroundUrl) {
            ...
            backgroundUrl = quotedImageUrl || defaultBg;
