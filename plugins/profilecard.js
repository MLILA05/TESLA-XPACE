...
cmd({
  ...
  try {
    ...
    if (!args.length) {
      return reply(
`✨ *Example Usage:*
.profilecard name=IMMU-MD rankName=Pro rankId=2 level=15 exp=500 requireExp=900 avatarURL=https://i.postimg.cc/sX3jN3p0/immu-md.png.jpg backgroundURL=https://i.postimg.cc/sX3jN3p0/immu-md.png
