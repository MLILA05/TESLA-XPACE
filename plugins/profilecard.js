...
cmd({
  ...
  try {
    ...
    if (!args.length) {
      return reply(
`✨ *Example Usage:*
.profilecard name=TESLA-XPACE-MD rankName=Pro rankId=2 level=15 exp=500 requireExp=900 avatarURL=https://files.catbox.moe/xksplb.jpg.jpg backgroundURL=https://files.catbox.moe/xksplb.jpg
...
🧩 *Tip:* Replace the values with your own name, level, and images.`
    ...
    const backgroundURL = params.backgroundURL || params.bg || "https://files.catbox.moe/xksplb.jpg";
